...
export const Positionable = React.forwardRef<HTMLDivElement, Props>(
  ({ children, transformMatrix, width, height }, ref) => {
    ...
    return (
      <div ref={ref} className="canvasPositionable canvasInteractable" style={newStyle}>
        {childNode}
      </div>
    );
  }
